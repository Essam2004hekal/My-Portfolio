  ...
  return (
    ...
    <section id='contact'>
      <div className="container">
        <div className="row">
            <h1 data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">contact us</h1>
        </div>
        <div className="row">
        ...
        <form ref={form} onSubmit={sendEmail} className="row input-container">
            ...
            <div className="col-md-6 col-sm-12">
              <div className="styled-input" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
                <input type="text" name='email' required />
                <label>Email</label> 
              </div>
            </div>
            <div className="col-md-6 col-sm-12">
              <div className="styled-input" style={{ float: "right" }} data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
